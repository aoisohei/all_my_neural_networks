...
#### _Notes:_ 
#### _Train processe :_
 слои, расположенные глубже в сети, визуализируют больше конкретных функций обучающих данных, в то время как более ранние слои имеют тенденцию визуализировать общие шаблоны, такие как края, текстура, фони т. д.  все слои по-разному рассматривают входное изображение, создавая уникальную абстракцию изображения на основе своих фильтров
